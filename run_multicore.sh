export IMAGE_PATH=/Users/libo/Work/disk_img/gem5_arm_linux_images
export M5_PATH="/Users/libo/Work/disk_img/gem5_arm_linux_images"

# 默认启动命令d9300，可对应修改d9300 -> d9200
#./build/ARM/gem5.opt configs/example/arm/arm_multicore_d9300.py --cpu-type="D9300" --disk=${IMAGE_PATH}/ubuntu-18.04-arm64-docker.img --kernel=${IMAGE_PATH}/../binaries/vmlinux.arm64 --bootscript configs/gemmini/fs-run.rcS --enable-gemmini --gemmini-cpu-idx 0 --gemmini-ctrl-addr 0x40000000 --gemmini-ctrl-size 0x1000 
./build/ARM/gem5.opt configs/example/arm/arm_multicore_d9300.py --cpu-type="D9300" --disk=${IMAGE_PATH}/ubuntu-18.04-arm64-docker.img --kernel=${IMAGE_PATH}/../binaries/vmlinux.arm64
# 按照指定slice dump启动命令
