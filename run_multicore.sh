...
./build/ARM/gem5.fast configs/example/arm/arm_multicore_slc.py --restore=./m5out/cpt.1349300388627 --disk=${IMAGE_PATH}/ubuntu-18.04-arm64-docker.img --kernel=${IMAGE_PATH}/../binaries/vmlinux.arm64 --caches --cpu-type="x4a720"
